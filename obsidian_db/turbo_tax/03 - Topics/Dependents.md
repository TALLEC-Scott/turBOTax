...
A dependent is a person other than you or your spouse who entitles you to claim certain tax benefits, including the dependent exemption and various credits.
...
| **Age** | Must be under age 19 (under 24 if a full-time student) or any age if permanently and totally disabled |
...
#### Special Rules for Qualifying Child

- **Temporary absences** count as time lived with you (school, vacation, illness, military)
- **Kidnapped children** may be treated as meeting the residency test
...
#### Relatives Who Don't Need to Live With You
- Child, stepchild, foster child, or descendant
- Sibling, half-sibling, step-sibling
- Parent, stepparent, grandparent
- Niece, nephew, aunt, uncle, in-law

#### Support Test Details
- **Total support** includes food, shelter, clothing, education, medical care, and recreation
- **Scholarships** are not included in support for full-time students
- **Tax-exempt income** (like Social Security) used for support IS counted
...
- Education expenses may qualify for deductions or credits

## Multiple Support Agreements

When two or more people together provide more than half of a person's support but no one person provides more than half:

1. One person can claim the dependent
2. Must file Form 2120 (Multiple Support Declaration)
3. Each provider must sign the form
4. The person claiming the dependent must meet other tests

## Children of Divorced or Separated Parents

The custodial parent (the parent the child lived with for the greater number of nights) generally claims the child as a dependent.

### Release of Claim to Noncustodial Parent
The custodial parent can release the claim by signing Form 8332 (Release of Claim to Exemption for Child of Divorced or Separated Parents) if:
...
- The divorce or separation agreement is from after 1984
...
- [[Pub 17 - Your Federal Income Tax]] - Chapter 3
- [[Pub 501 - Dependents, Standard Deduction, and Filing Information]] - Comprehensive rules
